// app.js — Nexus Salon (Firestore, PIN, páginas separadas)
...
/* ========== ESTADO LOCAL ========== */
const LOCAL_KEY = "nexus_salon_state_v2";
...
async function saveTicket() {
  ...
  try {
    ...
    // escritura directa a Firestore; onSnapshot actualiza todos los devices
